...
<img src="screenshots/postbird-for-macos-main-window-light-mode.png" alt="Main window (light mode)" width="100%">
<em>Main window (light mode)</em>
</td>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-three-pane-window-light-mode.png" alt="Three-pane window (light mode)" width="100%">
<em>Three-pane window (light mode)</em>
</td>
</tr>
<tr>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-message-window-light-mode.png" alt="Message window (light mode)" width="100%">
<em>Message window (light mode)</em>
</td>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-compose-message-window-light-mode.png" alt="Compose message window (light mode)" width="100%">
...
<tr>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-main-window-dark-mode.png" alt="Main window (dark mode)" width="100%">
<em>Main window (dark mode)</em>
</td>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-three-pane-window-dark-mode.png" alt="Three-pane window (dark mode)" width="100%">
<em>Three-pane window (dark mode)</em>
</td>
</tr>
<tr>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-reply-window-dark-mode.png" alt="Reply window (dark mode)" width="100%">
<em>Reply window (dark mode)</em>
</td>
<td align="center" width="50%">
<img src="screenshots/postbird-for-macos-compose-window-dark-mode.png" alt="Compose window (dark mode)" width="100%">
